...
| `polyhaven_import <id> [1k\|2k\|4k\|8k] [<file>.mat] [height]` | downloads the maps into `Assets/Textures/PolyHaven/<id>/` and creates (or repoints) material `<id>`. Asynchronous: poll `polyhaven_status` until `import=idle`. Undoable as two steps (maps, then the material) |
